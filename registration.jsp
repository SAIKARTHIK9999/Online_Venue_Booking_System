...
<head>
    ...
    <jsp:include page="./menu.html" />
        ...
        <form name="form1" action="RegistrationProcess.jsp" onsubmit="return regValidation()" method="POST" >
        <center>
            <table cellpadding="10px">
                <tr>
                    <td><label for="username">User Name:*</label></td>
                    <td><input type="text" id="name" name="u_name" placeholder= "user name" autocomplete="off" required/>
                    <img src="media\mike.png" onclick="startDictation('name')">
                    <script src="js/Speech_Dictation.js"></script>
                    </td>
                </tr>
                <tr>
                    <td><label for="pwd">Enter Password:*</label></td>
                    <td><input type="password" id="upwd" name="upwd" placeholder= "enter password"  autocomplete="off" />
                    </td>
                </tr>
                <tr>
                    <td><label for="cpwd">Confirm Password:*</label></td>
                    <td><input type="password" id="c_upwd" name="c_upwd" placeholder= "confirm password" autocomplete="off"  />
                    </td>
                </tr>
                 <tr>
                    ...
                    <img src="media\mike.png" width="40px" onclick="startDictation('phone')">
						<script src="js/Speech_Dictation.js"></script>
                    </td>
                </tr>
                <tr>
                ...
                <div class="radio-group">
                        ...
                        <td>
                        <label class="radio"><input type="radio" value="male" id="m" name="gender">&nbsp;<i id="icon"class="fa fa-male" aria-hidden="true"></i>&nbsp;male<span></span></label>
                        &nbsp;&nbsp;&nbsp;&nbsp;<label class="radio"><input type="radio" value="female" id="f" name="gender">&nbsp;<i id ="icon"class="fa fa-female" aria-hidden="true"></i>&nbsp;female<span></span></label>
                        </td>
                    </div>
            </div>
            </tr>
                ...
                <td><input type="submit" id="register_0" class="btn btn-success" value="Register"/></td>
                <td><input type="reset" id="register_1" class="btn btn-danger" value="Reset"/></td>

                <td><a id="hm" href="index.jsp"><button type="button" class="btn btn-primary">Home</button></a></td>
                <td><a id="log" href="memberlogin.jsp"><button type="button" class="btn btn-warning">Login</button></a></td>
