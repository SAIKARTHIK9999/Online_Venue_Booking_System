...
<head>
	...
	<jsp:include page="./header.html" />
		<form name="form1" action="vplogin_pr.jsp" method="POST">
		<section>
	        	<table cellpadding="20px">
	        		<tr>
		        		<td><label for="txt_username">Venue Provider:</label></td>
		        		<td><input id="name" type="text" name="txt_uname" autocomplete="off" placeholder="Venue Provider name" required>
		        	...
		        	<tr>
						...
						<img src="../media\mike.png" width="40px" onclick="startDictation('txt_pwd')">
						<script src="../js/Speech_Dictation.js"></script>
						</td>
		        	</tr>
		        	<tr id="register_1">
		        	...
		        	<tr>
		        		<td colspan="2"><a href="./reg_venp.jsp"><button type="button" class="btn btn-primary">New User? Register</button></a><br>
		        		  <br>
