...
try
{
    ...
    int i=stmt.executeUpdate("insert into venue_providers(user_name, password, phone, email, address, gender)values('"+user_name+"','"+pwd+"','"+phone+"','"+email+"','"+address+"','"+gender+"')");%>


    <h1><b><center>
    <%out.println("Data is successfully inserted!");%>
    <p>now you can login with your credentials</p>
    <a id="log" href="vplogin.jsp"><button type="button" class="btn btn-warning">Login</button></a>
    </center></b></h1>
